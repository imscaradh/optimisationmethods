...
\begin{align}
    \frac{0.243902x}{\sqrt{m^2+x^2}}+\frac{-0.952381 m+0.47619 x}{\sqrt{5 m^2-4 m x+x^2}} 
\end{align}

Setzen wir diese Gleichung zu 0 und lösen nach $x$ auf, erhalten wir als Resultat:
\[
    x = 1.5259m
\]


TODO-> Alle 4 Parameterberücksichtigen, Plots
